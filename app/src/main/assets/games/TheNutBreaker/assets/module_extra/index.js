...
System.register("chunks:///_virtual/UI_Setting_Impl.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioMgr.ts","./tgx.ts","./GameUILayers.ts","./UIDef.ts","./Layout_Setting.ts","./NutGameAudioMgr.ts","./ModuleContext.ts"],(function(t){var i,n,e,o,s,u,c,g;return{setters:[function(t){i=t.inheritsLoose},function(t){n=t.cclegacy},function(t){e=t.AudioMgr},null,function(t){o=t.GameUILayers},function(t){s=t.UI_Setting},function(t){u=t.Layout_Setting},function(t){c=t.NutGameAudioMgr},function(t){g=t.ModuleContext}],execute:function(){n._RF.push({},"bf6207lZAVGO4mPPabXKPX4","UI_Setting_Impl",void 0);var l=t("UI_Setting_Impl",function(t){function n(){return t.call(this,"ui_setting/UI_Setting",o.POPUP,u)||this}i(n,t);var s=n.prototype;return s.getRes=function(){return[]},s.onCreated=function(){var t=this,i=this.layout;this.onButtonEvent(i.btnClose,(function(){c.playOneShot(c.getMusicIdName(5),1),t.hide()})),this.initilizeUI()},s.initilizeUI=function(){var t=this.layout,i=t.musicToggle,n=t.soundToggle;i.node.on("toggle",this.musicSwitch,this),n.node.on("toggle",this.soundSwitch,this);var o=e.inst,s=o.bgMusicEnabled,u=o.soundEffectsEnabled;e.inst.toggleBgMusic(s),e.inst.toggleBgMusic(u),i.isChecked=s,n.isChecked=u},s.musicSwitch=function(t){e.inst.toggleBgMusic(t.isChecked)},s.soundSwitch=function(t){e.inst.toggleSoundEffects(t.isChecked)},n}(s));g.attachImplClass(s,l),n._RF.pop()}}}));
