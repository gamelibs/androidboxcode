            ...
            try {
                ...
                cached.forEach((item) => {
                    try {
                        ...
                        try {
                            console.warn('[AndroidCp] 重放占位事件失败:', e && e.message);
                        } catch (_) { }
                    }
                });

                try {
                    this.__sdklog('[AndroidCp] 已重放占位期间缓存的事件');
                } catch (_) { }
            } catch (e) {
                try {
                    console.warn('[AndroidCp] 重放占位事件时出错:', e && e.message);
                } catch (_) { }
            }
        }
